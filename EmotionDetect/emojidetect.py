...
kamera = cv2.VideoCapture(0)  # 0, yerel kamera için kullanılır. Farklı bir cihaz kullanıyorsanız, cihazın indeksini belirtmelisiniz.
...
while kamera.isOpened():
    ...
    if (cv2.waitKey(1) & 0xFF == ord('q')):  # 30 milisaniye beklemek yerine her 1 milisaniyede bir kontrol eder.
        break
